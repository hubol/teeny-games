...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Doll: {
      ...
      Button: tx({ id: "Doll.Button", atlas: 0, x: 350, y: 84, width: 30, height: 30 }),
      EarShadow0: tx({ id: "Doll.EarShadow0", atlas: 0, x: 257, y: 55, width: 26, height: 42 }),
      Ear0: tx({ id: "Doll.Ear0", atlas: 0, x: 257, y: 98, width: 26, height: 42 }),
      Eye0: tx({ id: "Doll.Eye0", atlas: 0, x: 350, y: 55, width: 32, height: 28 }),
      Sclera0: tx({ id: "Doll.Sclera0", atlas: 0, x: 383, y: 55, width: 32, height: 28 }),
    },
    Font: {
    ...
    Overlay: {
      ...
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 309, y: 55, width: 40, height: 60 }),
    },
  };
}
