...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      ...
      Chicken: {
        ...
        Runners: {
          Black: {
            ...
            South: tx({ id: "Characters.Chicken.Runners.Black.South", atlas: 0, x: 1535, y: 4039, width: 76, height: 34 }),
          },
          Brown: {
            East: tx({ id: "Characters.Chicken.Runners.Brown.East", atlas: 0, x: 1612, y: 4039, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Brown.North", atlas: 0, x: 1689, y: 4039, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Brown.South", atlas: 0, x: 895, y: 3399, width: 76, height: 34 }),
          },
          Gray: {
            East: tx({ id: "Characters.Chicken.Runners.Gray.East", atlas: 0, x: 972, y: 3399, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Gray.North", atlas: 0, x: 1990, y: 1348, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Gray.South", atlas: 0, x: 1990, y: 1383, width: 76, height: 34 }),
          },
        },
      },
      George: {
      ...
      Mystery: tx({ id: "Characters.Mystery", atlas: 0, x: 4034, y: 253, width: 48, height: 48 }),
      Pete: {
        Runner: {
          East: tx({ id: "Characters.Pete.Runner.East", atlas: 0, x: 1990, y: 1418, width: 76, height: 46 }),
          North: tx({ id: "Characters.Pete.Runner.North", atlas: 0, x: 1737, y: 3112, width: 76, height: 46 }),
          South: tx({ id: "Characters.Pete.Runner.South", atlas: 0, x: 1455, y: 2985, width: 76, height: 46 }),
        },
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 1409, y: 3086, width: 240, height: 112 }),
      },
      Runner: {
        HoldingStringNorth: tx({ id: "Characters.Runner.HoldingStringNorth", atlas: 0, x: 1455, y: 3032, width: 68, height: 38 }),
        HoldingStringSouth: tx({ id: "Characters.Runner.HoldingStringSouth", atlas: 0, x: 1524, y: 3032, width: 68, height: 38 }),
        Shadow: tx({ id: "Characters.Runner.Shadow", atlas: 0, x: 1417, y: 2945, width: 34, height: 38 }),
      },
      Stopwatch: tx({ id: "Characters.Stopwatch", atlas: 0, x: 2067, y: 1391, width: 32, height: 38 }),
    ...
    Effects: {
      ...
      Spark: tx({ id: "Effects.Spark", atlas: 0, x: 2067, y: 1430, width: 26, height: 38 }),
    },
    Faces: {
      ...
      Pixel: {
        ...
        BlackOlive: tx({ id: "Faces.Pixel.BlackOlive", atlas: 0, x: 1737, y: 3159, width: 76, height: 36 }),
        ...
        Spinach: tx({ id: "Faces.Pixel.Spinach", atlas: 0, x: 1365, y: 4039, width: 84, height: 50 }),
        Strawberry: tx({ id: "Faces.Pixel.Strawberry", atlas: 0, x: 1450, y: 4039, width: 84, height: 42 }),
    ...
    Pizza: {
      Cheese: tx({ id: "Pizza.Cheese", atlas: 0, x: 1409, y: 3199, width: 68, height: 56 }),
    ...
    Toppings: {
      ...
      Pixel: {
        BananaPepper: tx({ id: "Toppings.Pixel.BananaPepper", atlas: 0, x: 4034, y: 409, width: 36, height: 36 }),
        BlackOlive: tx({ id: "Toppings.Pixel.BlackOlive", atlas: 0, x: 4034, y: 372, width: 38, height: 36 }),
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 1593, y: 2985, width: 54, height: 52 }),
        Kiwi: tx({ id: "Toppings.Pixel.Kiwi", atlas: 0, x: 1593, y: 3038, width: 48, height: 46 }),
        MandarinOrange: tx({ id: "Toppings.Pixel.MandarinOrange", atlas: 0, x: 4034, y: 302, width: 48, height: 34 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 1532, y: 2985, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 4034, y: 202, width: 50, height: 50 }),
        ...
        Strawberry: tx({ id: "Toppings.Pixel.Strawberry", atlas: 0, x: 2067, y: 1348, width: 42, height: 42 }),
        Tomato: tx({ id: "Toppings.Pixel.Tomato", atlas: 0, x: 4034, y: 337, width: 48, height: 34 }),
      },
