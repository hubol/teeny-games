...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 54 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      Chicken: {
        Gray: tx({ id: "Characters.Chicken.Gray", atlas: 0, x: 2050, y: 1511, width: 264, height: 112 }),
      },
      George: {
      ...
      Pete: {
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 2829, y: 1538, width: 240, height: 112 }),
      },
      Tuna: tx({ id: "Characters.Tuna", atlas: 0, x: 0, y: 1201, width: 1024, height: 508 }),
    },
    Containers: {
      GreenPepper: tx({ id: "Containers.GreenPepper", atlas: 0, x: 2829, y: 1651, width: 224, height: 126 }),
      Happy: {
        GreenPepper: tx({ id: "Containers.Happy.GreenPepper", atlas: 0, x: 2572, y: 1667, width: 224, height: 126 }),
    ...
    Effects: {
      ...
      Clouds: tx({ id: "Effects.Clouds", atlas: 0, x: 2315, y: 1538, width: 256, height: 64 }),
    ...
    Faces: {
      ...
      Pepperoni: tx({ id: "Faces.Pepperoni", atlas: 0, x: 3054, y: 1651, width: 128, height: 30 }),
      Pixel: {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3054, y: 1682, width: 128, height: 8 }),
      ...
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 2572, y: 1538, width: 256, height: 128 }),
    ...
    Toppings: {
      Beef: tx({ id: "Toppings.Beef", atlas: 0, x: 3054, y: 1691, width: 60, height: 60 }),
      ...
      Pepperoni: tx({ id: "Toppings.Pepperoni", atlas: 0, x: 3070, y: 1538, width: 86, height: 84 }),
      Pineapple0: tx({ id: "Toppings.Pineapple0", atlas: 0, x: 2315, y: 1603, width: 256, height: 200 }),
      Pineapple1: tx({ id: "Toppings.Pineapple1", atlas: 0, x: 2050, y: 1624, width: 256, height: 180 }),
      Pixel: {
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 3115, y: 1691, width: 54, height: 52 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 3717, y: 108, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 846, y: 1710, width: 50, height: 50 }),
