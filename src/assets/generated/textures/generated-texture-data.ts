...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      Chicken: {
        ...
        Runners: {
          Black: {
            ...
            North: tx({ id: "Characters.Chicken.Runners.Black.North", atlas: 0, x: 3985, y: 1886, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Black.South", atlas: 0, x: 3985, y: 1921, width: 76, height: 34 }),
          },
          Brown: {
            East: tx({ id: "Characters.Chicken.Runners.Brown.East", atlas: 0, x: 3985, y: 1956, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Brown.North", atlas: 0, x: 3920, y: 1991, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Brown.South", atlas: 0, x: 3997, y: 1991, width: 76, height: 34 }),
          },
          Gray: {
            East: tx({ id: "Characters.Chicken.Runners.Gray.East", atlas: 0, x: 3920, y: 2026, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Gray.North", atlas: 0, x: 3997, y: 2026, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Gray.South", atlas: 0, x: 3456, y: 1935, width: 76, height: 34 }),
          },
        },
      },
      George: {
        Runner: {
          ...
          North: tx({ id: "Characters.George.Runner.North", atlas: 0, x: 3982, y: 1802, width: 84, height: 40 }),
          South: tx({ id: "Characters.George.Runner.South", atlas: 0, x: 3920, y: 1843, width: 84, height: 40 }),
        },
      ...
      Mystery: tx({ id: "Characters.Mystery", atlas: 0, x: 3141, y: 1613, width: 48, height: 48 }),
      Pete: {
        Runner: {
          East: tx({ id: "Characters.Pete.Runner.East", atlas: 0, x: 3533, y: 1935, width: 76, height: 46 }),
          North: tx({ id: "Characters.Pete.Runner.North", atlas: 0, x: 3456, y: 1970, width: 76, height: 46 }),
          South: tx({ id: "Characters.Pete.Runner.South", atlas: 0, x: 3533, y: 1982, width: 76, height: 46 }),
        },
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 3846, y: 0, width: 240, height: 112 }),
      },
      Runner: {
        HoldingStringNorth: tx({ id: "Characters.Runner.HoldingStringNorth", atlas: 0, x: 3456, y: 2017, width: 68, height: 38 }),
        HoldingStringSouth: tx({ id: "Characters.Runner.HoldingStringSouth", atlas: 0, x: 3525, y: 2029, width: 68, height: 38 }),
        Shadow: tx({ id: "Characters.Runner.Shadow", atlas: 0, x: 4062, y: 1886, width: 34, height: 38 }),
      },
      Stopwatch: tx({ id: "Characters.Stopwatch", atlas: 0, x: 4062, y: 1925, width: 32, height: 38 }),
    ...
    Condiments: {
      ...
      Oregano: tx({ id: "Condiments.Oregano", atlas: 0, x: 3263, y: 1935, width: 192, height: 118 }),
    ...
    Effects: {
      ...
      Spark: tx({ id: "Effects.Spark", atlas: 0, x: 4067, y: 1802, width: 26, height: 38 }),
    },
    Faces: {
      ...
      Pixel: {
        ...
        Kiwi: tx({ id: "Faces.Pixel.Kiwi", atlas: 0, x: 3982, y: 1755, width: 96, height: 46 }),
        ...
        Strawberry: tx({ id: "Faces.Pixel.Strawberry", atlas: 0, x: 4005, y: 1843, width: 84, height: 42 }),
    ...
    Font: {
      ...
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 3263, y: 1910, width: 102, height: 24 }),
    ...
    Overlay: {
      ...
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 3920, y: 1884, width: 64, height: 80 }),
      WarningError: tx({ id: "Overlay.WarningError", atlas: 0, x: 3982, y: 1710, width: 108, height: 44 }),
    },
    Pizza: {
      Cheese: tx({ id: "Pizza.Cheese", atlas: 0, x: 3594, y: 2029, width: 68, height: 56 }),
    ...
    Toppings: {
      ...
      Pixel: {
        ...
        Kiwi: tx({ id: "Toppings.Pixel.Kiwi", atlas: 0, x: 3141, y: 1662, width: 48, height: 46 }),
        ...
        Pineapple: tx({ id: "Toppings.Pixel.Pineapple", atlas: 0, x: 3610, y: 1986, width: 50, height: 38 }),
        Strawberry: tx({ id: "Toppings.Pixel.Strawberry", atlas: 0, x: 3141, y: 1744, width: 42, height: 42 }),
        Tomato: tx({ id: "Toppings.Pixel.Tomato", atlas: 0, x: 3141, y: 1709, width: 48, height: 34 }),
      },
