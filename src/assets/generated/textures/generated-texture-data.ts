...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Doll: {
      ...
      EarShadow0: tx({ id: "Doll.EarShadow0", atlas: 0, x: 901, y: 2006, width: 26, height: 42 }),
      Ear0: tx({ id: "Doll.Ear0", atlas: 0, x: 928, y: 2006, width: 26, height: 42 }),
      Eye0: tx({ id: "Doll.Eye0", atlas: 0, x: 2014, y: 21, width: 32, height: 28 }),
      Hair: tx({ id: "Doll.Hair", atlas: 0, x: 756, y: 1981, width: 144, height: 60 }),
      Leg: tx({ id: "Doll.Leg", atlas: 0, x: 0, y: 1898, width: 216, height: 148 }),
      Mouth0: tx({ id: "Doll.Mouth0", atlas: 0, x: 652, y: 1981, width: 66, height: 22 }),
      Mouth1: tx({ id: "Doll.Mouth1", atlas: 0, x: 2014, y: 203, width: 30, height: 30 }),
      Mouth2: tx({ id: "Doll.Mouth2", atlas: 0, x: 1359, y: 1055, width: 58, height: 22 }),
      ...
      Sock: tx({ id: "Doll.Sock", atlas: 0, x: 217, y: 1898, width: 216, height: 148 }),
      Washer0: tx({ id: "Doll.Washer0", atlas: 0, x: 2014, y: 106, width: 32, height: 32 }),
    },
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 434, y: 2040, width: 128, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 434, y: 2005, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 595, y: 2005, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 901, y: 1981, width: 102, height: 24 }),
    ...
    Fx: {
      ...
      Heart: tx({ id: "Fx.Heart", atlas: 0, x: 1184, y: 1038, width: 174, height: 148 }),
      ShadowMessy: tx({ id: "Fx.ShadowMessy", atlas: 0, x: 1962, y: 0, width: 86, height: 20 }),
      Star: tx({ id: "Fx.Star", atlas: 0, x: 1359, y: 1038, width: 64, height: 16 }),
    },
    Overlay: {
      CursorDown: tx({ id: "Overlay.CursorDown", atlas: 0, x: 434, y: 1779, width: 40, height: 60 }),
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 434, y: 1840, width: 40, height: 60 }),
    ...
    Shuttle: {
      Debris: tx({ id: "Shuttle.Debris", atlas: 0, x: 1968, y: 722, width: 78, height: 20 }),
