...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      ...
      Pete: {
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 2307, y: 1667, width: 240, height: 112 }),
      },
      Tuna: tx({ id: "Characters.Tuna", atlas: 0, x: 0, y: 1201, width: 1024, height: 508 }),
    },
    Containers: {
      GreenPepper: tx({ id: "Containers.GreenPepper", atlas: 0, x: 2050, y: 1777, width: 224, height: 126 }),
      Happy: {
        GreenPepper: tx({ id: "Containers.Happy.GreenPepper", atlas: 0, x: 2821, y: 1538, width: 224, height: 126 }),
    ...
    Effects: {
      ...
      Clouds: tx({ id: "Effects.Clouds", atlas: 0, x: 2050, y: 1511, width: 256, height: 64 }),
      ...
      Spark: tx({ id: "Effects.Spark", atlas: 0, x: 3752, y: 109, width: 26, height: 38 }),
    },
    Faces: {
      Idle: tx({ id: "Faces.Idle", atlas: 0, x: 2113, y: 0, width: 1136, height: 150 }),
      Pepperoni: tx({ id: "Faces.Pepperoni", atlas: 0, x: 3572, y: 109, width: 128, height: 30 }),
      Pixel: {
        ...
        Tomato: tx({ id: "Faces.Pixel.Tomato", atlas: 0, x: 3046, y: 1538, width: 144, height: 34 }),
      },
      Sing: tx({ id: "Faces.Sing", atlas: 0, x: 3194, y: 1036, width: 852, height: 150 }),
    },
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3572, y: 140, width: 128, height: 8 }),
      ...
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 2307, y: 1511, width: 102, height: 24 }),
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 2307, y: 1538, width: 256, height: 128 }),
      OldMaiden: tx({ id: "Font.OldMaiden", atlas: 0, x: 3747, y: 1557, width: 308, height: 208 }),
    },
    Overlay: {
      CursorDown: tx({ id: "Overlay.CursorDown", atlas: 0, x: 3109, y: 1370, width: 64, height: 80 }),
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 3109, y: 1451, width: 64, height: 80 }),
    },
    Pizza: {
    ...
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 3046, y: 1573, width: 62, height: 46 }),
    },
    Toppings: {
      Beef: tx({ id: "Toppings.Beef", atlas: 0, x: 3109, y: 1573, width: 60, height: 60 }),
      ...
      Pepperoni: tx({ id: "Toppings.Pepperoni", atlas: 0, x: 3076, y: 1285, width: 86, height: 84 }),
      Pineapple0: tx({ id: "Toppings.Pineapple0", atlas: 0, x: 2050, y: 1576, width: 256, height: 200 }),
      Pineapple1: tx({ id: "Toppings.Pineapple1", atlas: 0, x: 2564, y: 1538, width: 256, height: 180 }),
      Pixel: {
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 3046, y: 1620, width: 54, height: 52 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 3701, y: 108, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 3101, y: 1634, width: 50, height: 50 }),
