...
function txs<T>(tx: (data: TxData) => T) {
  return {
      ...
      Chicken: {
        ...
        Runners: {
          Black: {
            ...
            North: tx({ id: "Characters.Chicken.Runners.Black.North", atlas: 0, x: 1365, y: 4038, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Black.South", atlas: 0, x: 1442, y: 4039, width: 76, height: 34 }),
          },
          Brown: {
            East: tx({ id: "Characters.Chicken.Runners.Brown.East", atlas: 0, x: 1519, y: 4039, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Brown.North", atlas: 0, x: 1596, y: 4039, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Brown.South", atlas: 0, x: 1673, y: 4039, width: 76, height: 34 }),
          },
          Gray: {
            ...
            South: tx({ id: "Characters.Chicken.Runners.Gray.South", atlas: 0, x: 1737, y: 3112, width: 76, height: 34 }),
          },
        },
      },
      George: {
        Runner: {
          ...
          North: tx({ id: "Characters.George.Runner.North", atlas: 0, x: 1183, y: 3995, width: 84, height: 40 }),
          South: tx({ id: "Characters.George.Runner.South", atlas: 0, x: 1268, y: 3995, width: 84, height: 40 }),
        },
        Walk: tx({ id: "Characters.George.Walk", atlas: 0, x: 2971, y: 0, width: 318, height: 112 }),
      },
      MagnetTinted: tx({ id: "Characters.MagnetTinted", atlas: 0, x: 1990, y: 1348, width: 104, height: 106 }),
      Magnet: tx({ id: "Characters.Magnet", atlas: 0, x: 3290, y: 0, width: 312, height: 106 }),
      Mystery: tx({ id: "Characters.Mystery", atlas: 0, x: 1601, y: 3022, width: 48, height: 48 }),
      Pete: {
        Runner: {
          East: tx({ id: "Characters.Pete.Runner.East", atlas: 0, x: 1737, y: 3147, width: 76, height: 46 }),
          North: tx({ id: "Characters.Pete.Runner.North", atlas: 0, x: 1455, y: 2985, width: 76, height: 46 }),
          South: tx({ id: "Characters.Pete.Runner.South", atlas: 0, x: 1455, y: 3032, width: 76, height: 46 }),
        },
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 1409, y: 3086, width: 240, height: 112 }),
      },
      Runner: {
        HoldingStringNorth: tx({ id: "Characters.Runner.HoldingStringNorth", atlas: 0, x: 1532, y: 3022, width: 68, height: 38 }),
        HoldingStringSouth: tx({ id: "Characters.Runner.HoldingStringSouth", atlas: 0, x: 1409, y: 3199, width: 68, height: 38 }),
        Shadow: tx({ id: "Characters.Runner.Shadow", atlas: 0, x: 1417, y: 2945, width: 34, height: 38 }),
      },
      Stopwatch: tx({ id: "Characters.Stopwatch", atlas: 0, x: 1547, y: 3199, width: 32, height: 38 }),
    ...
    Effects: {
      ...
      Spark: tx({ id: "Effects.Spark", atlas: 0, x: 1547, y: 3238, width: 26, height: 38 }),
    },
    Faces: {
      ...
      Pixel: {
        BananaPepper: tx({ id: "Faces.Pixel.BananaPepper", atlas: 0, x: 4021, y: 0, width: 72, height: 36 }),
        BlackOlive: tx({ id: "Faces.Pixel.BlackOlive", atlas: 0, x: 1532, y: 2985, width: 76, height: 36 }),
        ...
        Spinach: tx({ id: "Faces.Pixel.Spinach", atlas: 0, x: 1280, y: 4039, width: 84, height: 50 }),
        Strawberry: tx({ id: "Faces.Pixel.Strawberry", atlas: 0, x: 1353, y: 3995, width: 84, height: 42 }),
        Tomato: tx({ id: "Faces.Pixel.Tomato", atlas: 0, x: 1990, y: 1455, width: 96, height: 34 }),
      },
    ...
    Pizza: {
      Cheese: tx({ id: "Pizza.Cheese", atlas: 0, x: 1478, y: 3199, width: 68, height: 56 }),
      ...
      Nail: tx({ id: "Pizza.Nail", atlas: 0, x: 1049, y: 3399, width: 16, height: 16 }),
      Sauce: tx({ id: "Pizza.Sauce", atlas: 0, x: 4034, y: 84, width: 60, height: 56 }),
    ...
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 4034, y: 37, width: 62, height: 46 }),
    },
    Toppings: {
      Beef: tx({ id: "Toppings.Beef", atlas: 0, x: 4034, y: 141, width: 60, height: 60 }),
      ...
      Pixel: {
        BananaPepper: tx({ id: "Toppings.Pixel.BananaPepper", atlas: 0, x: 4034, y: 509, width: 36, height: 36 }),
        BlackOlive: tx({ id: "Toppings.Pixel.BlackOlive", atlas: 0, x: 1609, y: 2985, width: 38, height: 36 }),
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 4034, y: 202, width: 54, height: 52 }),
        Kiwi: tx({ id: "Toppings.Pixel.Kiwi", atlas: 0, x: 4034, y: 349, width: 48, height: 46 }),
        MandarinOrange: tx({ id: "Toppings.Pixel.MandarinOrange", atlas: 0, x: 4034, y: 396, width: 48, height: 34 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 4034, y: 255, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 4034, y: 298, width: 50, height: 50 }),
        Pineapple: tx({ id: "Toppings.Pixel.Pineapple", atlas: 0, x: 3552, y: 107, width: 50, height: 38 }),
        Spinach: tx({ id: "Toppings.Pixel.Spinach", atlas: 0, x: 1417, y: 2894, width: 42, height: 50 }),
        Strawberry: tx({ id: "Toppings.Pixel.Strawberry", atlas: 0, x: 4034, y: 466, width: 42, height: 42 }),
        Tomato: tx({ id: "Toppings.Pixel.Tomato", atlas: 0, x: 4034, y: 431, width: 48, height: 34 }),
      },
