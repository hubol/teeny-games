...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      Magnet: tx({ id: "Characters.Magnet", atlas: 0, x: 810, y: 1801, width: 208, height: 106 }),
      Tuna: tx({ id: "Characters.Tuna", atlas: 0, x: 0, y: 1201, width: 1024, height: 508 }),
    },
    Containers: {
      GreenPepper: tx({ id: "Containers.GreenPepper", atlas: 0, x: 2307, y: 1511, width: 224, height: 126 }),
      Happy: {
        GreenPepper: tx({ id: "Containers.Happy.GreenPepper", atlas: 0, x: 2532, y: 1562, width: 224, height: 126 }),
        ...
        Tomato: tx({ id: "Containers.Happy.Tomato", atlas: 0, x: 3747, y: 1655, width: 288, height: 90 }),
      },
      ...
      Tomato: tx({ id: "Containers.Tomato", atlas: 0, x: 553, y: 1710, width: 288, height: 90 }),
    },
    Effects: {
    ...
    Font: {
      ...
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 2563, y: 1433, width: 256, height: 128 }),
    ...
    Toppings: {
      ...
      Pepperoni0: tx({ id: "Toppings.Pepperoni0", atlas: 0, x: 553, y: 1801, width: 256, height: 280 }),
      Pepperoni1: tx({ id: "Toppings.Pepperoni1", atlas: 0, x: 553, y: 2082, width: 256, height: 280 }),
      Pepperoni2: tx({ id: "Toppings.Pepperoni2", atlas: 0, x: 0, y: 2252, width: 256, height: 280 }),
      Pepperoni: tx({ id: "Toppings.Pepperoni", atlas: 0, x: 842, y: 1710, width: 86, height: 84 }),
      Pineapple0: tx({ id: "Toppings.Pineapple0", atlas: 0, x: 2820, y: 1433, width: 256, height: 200 }),
      Pineapple1: tx({ id: "Toppings.Pineapple1", atlas: 0, x: 2050, y: 1511, width: 256, height: 180 }),
      Pixel: {
