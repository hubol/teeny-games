...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Overlay: {
      CursorDown: tx({ id: "Overlay.CursorDown", atlas: 0, x: 3077, y: 1395, width: 64, height: 80 }),
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 3077, y: 1476, width: 64, height: 80 }),
    },
    Pizza: {
      ...
      Nail: tx({ id: "Pizza.Nail", atlas: 0, x: 530, y: 2252, width: 16, height: 16 }),
      Shading: tx({ id: "Pizza.Shading", atlas: 0, x: 2113, y: 151, width: 1080, height: 1080 }),
    },
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 3077, y: 1557, width: 62, height: 46 }),
    },
    Toppings: {
      Beef: tx({ id: "Toppings.Beef", atlas: 0, x: 3077, y: 1604, width: 60, height: 60 }),
      ...
      Pixel: {
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 3138, y: 1604, width: 54, height: 52 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 3142, y: 1395, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 3142, y: 1438, width: 50, height: 50 }),
