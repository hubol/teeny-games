...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Containers: {
      GreenPepper: tx({ id: "Containers.GreenPepper", atlas: 0, x: 2050, y: 1511, width: 224, height: 126 }),
      Happy: {
        GreenPepper: tx({ id: "Containers.Happy.GreenPepper", atlas: 0, x: 2275, y: 1511, width: 224, height: 126 }),
    ...
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 2500, y: 1511, width: 62, height: 46 }),
    },
    Toppings: {
