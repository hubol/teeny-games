...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 762, y: 246, width: 128, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 762, y: 176, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 762, y: 211, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 891, y: 246, width: 102, height: 24 }),
