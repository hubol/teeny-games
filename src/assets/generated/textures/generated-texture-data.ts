...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Characters: {
      Chicken: {
        ...
        Runners: {
          Black: {
            ...
            North: tx({ id: "Characters.Chicken.Runners.Black.North", atlas: 0, x: 3920, y: 1882, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Black.South", atlas: 0, x: 3920, y: 1917, width: 76, height: 34 }),
          },
          Brown: {
            East: tx({ id: "Characters.Chicken.Runners.Brown.East", atlas: 0, x: 3997, y: 1920, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Brown.North", atlas: 0, x: 3920, y: 1952, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Brown.South", atlas: 0, x: 3997, y: 1955, width: 76, height: 34 }),
          },
          Gray: {
            East: tx({ id: "Characters.Chicken.Runners.Gray.East", atlas: 0, x: 3920, y: 1987, width: 76, height: 34 }),
            North: tx({ id: "Characters.Chicken.Runners.Gray.North", atlas: 0, x: 3997, y: 1990, width: 76, height: 34 }),
            South: tx({ id: "Characters.Chicken.Runners.Gray.South", atlas: 0, x: 3920, y: 2022, width: 76, height: 34 }),
          },
        },
      },
      George: {
      ...
      Pete: {
        Runner: {
          East: tx({ id: "Characters.Pete.Runner.East", atlas: 0, x: 3997, y: 2025, width: 76, height: 46 }),
          North: tx({ id: "Characters.Pete.Runner.North", atlas: 0, x: 3456, y: 1935, width: 76, height: 46 }),
          South: tx({ id: "Characters.Pete.Runner.South", atlas: 0, x: 3533, y: 1935, width: 76, height: 46 }),
        },
        Walk: tx({ id: "Characters.Pete.Walk", atlas: 0, x: 3846, y: 0, width: 240, height: 112 }),
      },
      Runner: {
        HoldingStringNorth: tx({ id: "Characters.Runner.HoldingStringNorth", atlas: 0, x: 3456, y: 1982, width: 68, height: 38 }),
        HoldingStringSouth: tx({ id: "Characters.Runner.HoldingStringSouth", atlas: 0, x: 3525, y: 1982, width: 68, height: 38 }),
    ...
    Effects: {
      ...
      Spark: tx({ id: "Effects.Spark", atlas: 0, x: 4070, y: 1757, width: 26, height: 38 }),
    },
    Faces: {
      ...
      Pixel: {
        ...
        Strawberry: tx({ id: "Faces.Pixel.Strawberry", atlas: 0, x: 3920, y: 1839, width: 84, height: 42 }),
