...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3702, y: 80, width: 128, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 3931, y: 0, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 3931, y: 35, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 3885, y: 70, width: 102, height: 24 }),
    ...
    Library: {
      ...
      Book: tx({ id: "Library.Book", atlas: 0, x: 3702, y: 47, width: 182, height: 32 }),
      Cart: tx({ id: "Library.Cart", atlas: 0, x: 3702, y: 0, width: 228, height: 46 }),
      Closing: tx({ id: "Library.Closing", atlas: 0, x: 2501, y: 281, width: 456, height: 12 }),
      Feces: tx({ id: "Library.Feces", atlas: 0, x: 3988, y: 70, width: 28, height: 28 }),
    },
    Lottie: {
    ...
    Reading: {
      ...
      ScoreBad: tx({ id: "Reading.ScoreBad", atlas: 0, x: 2922, y: 329, width: 66, height: 34 }),
      ScoreGood: tx({ id: "Reading.ScoreGood", atlas: 0, x: 2922, y: 294, width: 68, height: 34 }),
      ScoreOk: tx({ id: "Reading.ScoreOk", atlas: 0, x: 2922, y: 364, width: 60, height: 34 }),
    },
    Tbell: {
