...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Character: {
      ...
      Chicken: tx({ id: "Character.Chicken", atlas: 0, x: 73, y: 471, width: 60, height: 66 }),
      MishaHandOpened: tx({ id: "Character.MishaHandOpened", atlas: 0, x: 1122, y: 282, width: 44, height: 50 }),
      MishaHand: tx({ id: "Character.MishaHand", atlas: 0, x: 627, y: 276, width: 44, height: 50 }),
    ...
    Font: {
      ...
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 1922, y: 23, width: 102, height: 24 }),
    ...
    Fx: {
      ...
      Z: tx({ id: "Fx.Z", atlas: 0, x: 2025, y: 23, width: 22, height: 24 }),
    },
    Item: {
      Box: tx({ id: "Item.Box", atlas: 0, x: 587, y: 453, width: 124, height: 56 }),
      CarrotGrated: tx({ id: "Item.CarrotGrated", atlas: 0, x: 627, y: 327, width: 50, height: 24 }),
      ...
      EggBroken: tx({ id: "Item.EggBroken", atlas: 0, x: 1122, y: 227, width: 42, height: 54 }),
      Egg: tx({ id: "Item.Egg", atlas: 0, x: 2003, y: 227, width: 40, height: 46 }),
      Flour: tx({ id: "Item.Flour", atlas: 0, x: 134, y: 471, width: 54, height: 64 }),
      GarlicGrated: tx({ id: "Item.GarlicGrated", atlas: 0, x: 254, y: 471, width: 24, height: 18 }),
      GarlicSmashed: tx({ id: "Item.GarlicSmashed", atlas: 0, x: 37, y: 566, width: 34, height: 36 }),
      Garlic: tx({ id: "Item.Garlic", atlas: 0, x: 320, y: 507, width: 38, height: 28 }),
      Grater: tx({ id: "Item.Grater", atlas: 0, x: 0, y: 566, width: 36, height: 42 }),
      HalfCupFlour: tx({ id: "Item.HalfCupFlour", atlas: 0, x: 359, y: 507, width: 38, height: 36 }),
      HalfCup: tx({ id: "Item.HalfCup", atlas: 0, x: 320, y: 536, width: 38, height: 36 }),
      Hammer: tx({ id: "Item.Hammer", atlas: 0, x: 248, y: 504, width: 30, height: 52 }),
      ...
      OnionGrated: tx({ id: "Item.OnionGrated", atlas: 0, x: 619, y: 363, width: 46, height: 26 }),
      Onion: tx({ id: "Item.Onion", atlas: 0, x: 189, y: 504, width: 58, height: 52 }),
      ...
      SaltShaker: tx({ id: "Item.SaltShaker", atlas: 0, x: 1122, y: 113, width: 32, height: 56 }),
      ScooperWithLatke: tx({ id: "Item.ScooperWithLatke", atlas: 0, x: 134, y: 536, width: 48, height: 42 }),
      Scooper: tx({ id: "Item.Scooper", atlas: 0, x: 73, y: 538, width: 48, height: 42 }),
      Skillet: tx({ id: "Item.Skillet", atlas: 0, x: 279, y: 200, width: 90, height: 20 }),
      SmokeAlarm: tx({ id: "Item.SmokeAlarm", atlas: 0, x: 279, y: 507, width: 40, height: 42 }),
      Smoke: tx({ id: "Item.Smoke", atlas: 0, x: 2038, y: 111, width: 10, height: 20 }),
      WhiskyGlassFull: tx({ id: "Item.WhiskyGlassFull", atlas: 0, x: 712, y: 453, width: 26, height: 36 }),
      WhiskyGlass: tx({ id: "Item.WhiskyGlass", atlas: 0, x: 712, y: 490, width: 26, height: 36 }),
      Whisky: tx({ id: "Item.Whisky", atlas: 0, x: 1122, y: 170, width: 36, height: 56 }),
    },
    Shapes: {
      Mess0: tx({ id: "Shapes.Mess0", atlas: 0, x: 615, y: 425, width: 148, height: 18 }),
      RadiatingRectangle64px32px: tx({ id: "Shapes.RadiatingRectangle64px32px", atlas: 0, x: 189, y: 471, width: 64, height: 32 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 398, y: 507, width: 32, height: 32 }),
    },
    Ui: {
      Error: tx({ id: "Ui.Error", atlas: 0, x: 1169, y: 49, width: 500, height: 280 }),
      Target: tx({ id: "Ui.Target", atlas: 0, x: 279, y: 550, width: 22, height: 34 }),
    },
    World: {
      ...
      Text: {
        Birds: tx({ id: "World.Text.Birds", atlas: 0, x: 0, y: 471, width: 72, height: 94 }),
