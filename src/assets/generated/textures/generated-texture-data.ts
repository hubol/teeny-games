...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Containers: {
      GreenPepper: tx({ id: "Containers.GreenPepper", atlas: 0, x: 2050, y: 1712, width: 224, height: 126 }),
      Happy: {
        GreenPepper: tx({ id: "Containers.Happy.GreenPepper", atlas: 0, x: 2564, y: 1538, width: 224, height: 126 }),
      ...
      Onion: tx({ id: "Containers.Onion", atlas: 0, x: 2563, y: 1433, width: 272, height: 104 }),
    ...
    Faces: {
      ...
      Pixel: {
        ...
        Mushroom: tx({ id: "Faces.Pixel.Mushroom", atlas: 0, x: 3093, y: 1285, width: 100, height: 42 }),
        Onion: tx({ id: "Faces.Pixel.Onion", atlas: 0, x: 3093, y: 1328, width: 100, height: 50 }),
    ...
    Font: {
      ...
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 2836, y: 1433, width: 256, height: 128 }),
    ...
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 3668, y: 57, width: 62, height: 46 }),
    },
    Toppings: {
      ...
      Pepperoni0: tx({ id: "Toppings.Pepperoni0", atlas: 0, x: 553, y: 1710, width: 256, height: 280 }),
      Pepperoni1: tx({ id: "Toppings.Pepperoni1", atlas: 0, x: 553, y: 1991, width: 256, height: 280 }),
      Pepperoni2: tx({ id: "Toppings.Pepperoni2", atlas: 0, x: 0, y: 2252, width: 256, height: 280 }),
      Pepperoni: tx({ id: "Toppings.Pepperoni", atlas: 0, x: 3093, y: 1379, width: 86, height: 84 }),
      Pineapple0: tx({ id: "Toppings.Pineapple0", atlas: 0, x: 2050, y: 1511, width: 256, height: 200 }),
      Pineapple1: tx({ id: "Toppings.Pineapple1", atlas: 0, x: 2307, y: 1538, width: 256, height: 180 }),
      Pixel: {
        ...
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 3731, y: 57, width: 50, height: 50 }),
