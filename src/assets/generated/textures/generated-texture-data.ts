...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Toppings: {
      ...
      Pixel: {
        GreenPepper: tx({ id: "Toppings.Pixel.GreenPepper", atlas: 0, x: 4040, y: 1653, width: 54, height: 52 }),
        Mushroom: tx({ id: "Toppings.Pixel.Mushroom", atlas: 0, x: 4040, y: 1706, width: 50, height: 42 }),
        Onion: tx({ id: "Toppings.Pixel.Onion", atlas: 0, x: 4040, y: 1749, width: 50, height: 50 }),
