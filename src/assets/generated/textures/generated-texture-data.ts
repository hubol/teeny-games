...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Doll: {
      ...
      Eye0: tx({ id: "Doll.Eye0", atlas: 0, x: 422, y: 70, width: 32, height: 28 }),
      Sclera0: tx({ id: "Doll.Sclera0", atlas: 0, x: 422, y: 99, width: 32, height: 28 }),
    },
    Font: {
    ...
    Overlay: {
      CursorDown: tx({ id: "Overlay.CursorDown", atlas: 0, x: 470, y: 0, width: 40, height: 60 }),
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 470, y: 61, width: 40, height: 60 }),
    },
  };
}
