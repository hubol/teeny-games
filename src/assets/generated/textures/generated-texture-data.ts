...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Doll: {
      ...
      Button: tx({ id: "Doll.Button", atlas: 0, x: 2014, y: 705, width: 30, height: 30 }),
      EarShadow0: tx({ id: "Doll.EarShadow0", atlas: 0, x: 1398, y: 1175, width: 26, height: 42 }),
      Ear0: tx({ id: "Doll.Ear0", atlas: 0, x: 1398, y: 1218, width: 26, height: 42 }),
      Eye0: tx({ id: "Doll.Eye0", atlas: 0, x: 2014, y: 554, width: 32, height: 28 }),
      Hair: tx({ id: "Doll.Hair", atlas: 0, x: 1244, y: 1561, width: 144, height: 60 }),
      Leg: tx({ id: "Doll.Leg", atlas: 0, x: 635, y: 1561, width: 216, height: 148 }),
      Mouth0: tx({ id: "Doll.Mouth0", atlas: 0, x: 1968, y: 763, width: 66, height: 22 }),
      Mouth1: tx({ id: "Doll.Mouth1", atlas: 0, x: 1389, y: 1561, width: 30, height: 30 }),
      Mouth2: tx({ id: "Doll.Mouth2", atlas: 0, x: 1705, y: 763, width: 58, height: 22 }),
      Sclera0: tx({ id: "Doll.Sclera0", atlas: 0, x: 2014, y: 583, width: 32, height: 28 }),
      Screw0: tx({ id: "Doll.Screw0", atlas: 0, x: 2014, y: 612, width: 32, height: 26 }),
      Sock: tx({ id: "Doll.Sock", atlas: 0, x: 852, y: 1561, width: 216, height: 148 }),
      Washer0: tx({ id: "Doll.Washer0", atlas: 0, x: 2014, y: 639, width: 32, height: 32 }),
    },
    Font: {
      ...
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 1298, y: 1622, width: 102, height: 24 }),
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 1141, y: 1175, width: 256, height: 128 }),
      OldMaiden: tx({ id: "Font.OldMaiden", atlas: 0, x: 1705, y: 554, width: 308, height: 208 }),
    },
    Fx: {
      Displacement: tx({ id: "Fx.Displacement", atlas: 0, x: 1141, y: 1304, width: 256, height: 256 }),
      GhostBurst: tx({ id: "Fx.GhostBurst", atlas: 0, x: 0, y: 863, width: 1424, height: 174 }),
      Heart: tx({ id: "Fx.Heart", atlas: 0, x: 1069, y: 1561, width: 174, height: 148 }),
      ShadowMessy: tx({ id: "Fx.ShadowMessy", atlas: 0, x: 1962, y: 151, width: 86, height: 20 }),
      Star: tx({ id: "Fx.Star", atlas: 0, x: 695, y: 2027, width: 64, height: 16 }),
    },
    Overlay: {
      CursorDown: tx({ id: "Overlay.CursorDown", atlas: 0, x: 1244, y: 1622, width: 40, height: 60 }),
      Cursor: tx({ id: "Overlay.Cursor", atlas: 0, x: 1705, y: 786, width: 40, height: 60 }),
      GoButton: tx({ id: "Overlay.GoButton", atlas: 0, x: 549, y: 1908, width: 426, height: 118 }),
    },
    Shapes: {
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 2014, y: 672, width: 32, height: 32 }),
    },
    Shuttle: {
    ...
    Skate: {
      ...
      LetterR: tx({ id: "Skate.LetterR", atlas: 0, x: 1401, y: 1623, width: 20, height: 28 }),
      Stars: tx({ id: "Skate.Stars", atlas: 0, x: 1141, y: 1038, width: 274, height: 136 }),
