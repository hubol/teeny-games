...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Font: {
      ...
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 3930, y: 667, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 3930, y: 702, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 1850, y: 776, width: 102, height: 24 }),
    ...
    HotDog: {
      ...
      Relish: tx({ id: "HotDog.Relish", atlas: 0, x: 3887, y: 478, width: 40, height: 30 }),
    ...
    Soda: {
      ...
      IceCube: tx({ id: "Soda.IceCube", atlas: 0, x: 3887, y: 509, width: 26, height: 24 }),
      Pour: tx({ id: "Soda.Pour", atlas: 0, x: 3772, y: 478, width: 114, height: 62 }),
