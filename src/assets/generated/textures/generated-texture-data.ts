...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Bee: tx({ id: "Bee", atlas: 0, x: 900, y: 545, width: 96, height: 56 }),
    Character: {
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 896, y: 612, width: 128, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 483, y: 621, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 483, y: 656, width: 160, height: 34 }),
    ...
    Lands: {
      Debble: tx({ id: "Lands.Debble", atlas: 0, x: 896, y: 621, width: 126, height: 128 }),
      Flower: tx({ id: "Lands.Flower", atlas: 0, x: 873, y: 0, width: 82, height: 60 }),
      Foliage0: tx({ id: "Lands.Foliage0", atlas: 0, x: 912, y: 441, width: 98, height: 96 }),
      Rock0: tx({ id: "Lands.Rock0", atlas: 0, x: 0, y: 972, width: 84, height: 42 }),
      Splotch0: tx({ id: "Lands.Splotch0", atlas: 0, x: 0, y: 621, width: 482, height: 350 }),
    },
    Rainbow: {
      Angry: tx({ id: "Rainbow.Angry", atlas: 0, x: 655, y: 612, width: 240, height: 64 }),
      Sad: tx({ id: "Rainbow.Sad", atlas: 0, x: 655, y: 545, width: 244, height: 66 }),
    },
  };
}
