...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Faces: {
      ...
      Pepperoni: tx({ id: "Faces.Pepperoni", atlas: 0, x: 1835, y: 1662, width: 128, height: 30 }),
      Pixel: {
        GreenPepper: tx({ id: "Faces.Pixel.GreenPepper", atlas: 0, x: 1964, y: 1662, width: 108, height: 52 }),
        Mushroom: tx({ id: "Faces.Pixel.Mushroom", atlas: 0, x: 1835, y: 1715, width: 100, height: 42 }),
        Onion: tx({ id: "Faces.Pixel.Onion", atlas: 0, x: 1936, y: 1715, width: 100, height: 50 }),
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3250, y: 288, width: 128, height: 8 }),
      ...
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 1835, y: 1769, width: 256, height: 128 }),
    ...
    Toppings: {
      ...
      Pepperoni: tx({ id: "Toppings.Pepperoni", atlas: 0, x: 1835, y: 1898, width: 86, height: 84 }),
