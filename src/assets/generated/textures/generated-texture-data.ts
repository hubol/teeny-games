...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Shadows: {
      Tomato: tx({ id: "Shadows.Tomato", atlas: 0, x: 2474, y: 810, width: 62, height: 46 }),
    },
    Toppings: {
      Beef: tx({ id: "Toppings.Beef", atlas: 0, x: 2537, y: 810, width: 60, height: 60 }),
      ...
      Pixel: {
        Tomato: tx({ id: "Toppings.Pixel.Tomato", atlas: 0, x: 4046, y: 0, width: 48, height: 34 }),
      },
