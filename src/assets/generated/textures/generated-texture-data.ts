...
function txs<T>(tx: (data: TxData) => T) {
  return {
    Boot: {
      ...
      For: tx({ id: "Boot.For", atlas: 0, x: 3982, y: 338, width: 84, height: 44 }),
      Hear: tx({ id: "Boot.Hear", atlas: 0, x: 3982, y: 211, width: 114, height: 52 }),
      It: tx({ id: "Boot.It", atlas: 0, x: 3982, y: 383, width: 50, height: 56 }),
      Lets: tx({ id: "Boot.Lets", atlas: 0, x: 2067, y: 495, width: 122, height: 48 }),
      The: tx({ id: "Boot.The", atlas: 0, x: 3982, y: 289, width: 88, height: 48 }),
    },
    ...
    Font: {
      ...
      GoodBoy: tx({ id: "Font.GoodBoy", atlas: 0, x: 3762, y: 699, width: 256, height: 128 }),
    },
    Fucka: {
      Abdomen: tx({ id: "Fucka.Abdomen", atlas: 0, x: 2500, y: 546, width: 288, height: 232 }),
      Body: tx({ id: "Fucka.Body", atlas: 0, x: 3762, y: 828, width: 144, height: 232 }),
      Bottoms: tx({ id: "Fucka.Bottoms", atlas: 0, x: 2067, y: 546, width: 432, height: 232 }),
      Decoration: tx({ id: "Fucka.Decoration", atlas: 0, x: 2601, y: 0, width: 1008, height: 232 }),
      Eyes: tx({ id: "Fucka.Eyes", atlas: 0, x: 3907, y: 828, width: 144, height: 232 }),
      Footwear: tx({ id: "Fucka.Footwear", atlas: 0, x: 1490, y: 189, width: 720, height: 232 }),
      Hair: tx({ id: "Fucka.Hair", atlas: 0, x: 2789, y: 747, width: 144, height: 232 }),
      Mouth: tx({ id: "Fucka.Mouth", atlas: 0, x: 3329, y: 466, width: 432, height: 232 }),
      Mullet: tx({ id: "Fucka.Mullet", atlas: 0, x: 3329, y: 699, width: 432, height: 232 }),
      Nose: tx({ id: "Fucka.Nose", atlas: 0, x: 1490, y: 422, width: 576, height: 232 }),
      Penis: tx({ id: "Fucka.Penis", atlas: 0, x: 2934, y: 747, width: 144, height: 232 }),
    ...
    Palette: tx({ id: "Palette", atlas: 0, x: 4071, y: 289, width: 24, height: 48 }),
  };
}
