...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Doll: {
      ...
      EarShadow0: tx({ id: "Doll.EarShadow0", atlas: 0, x: 960, y: 2006, width: 26, height: 42 }),
      Ear0: tx({ id: "Doll.Ear0", atlas: 0, x: 987, y: 2006, width: 26, height: 42 }),
      ...
      Mouth2: tx({ id: "Doll.Mouth2", atlas: 0, x: 901, y: 2006, width: 58, height: 22 }),
    ...
    Fx: {
      ...
      Heart: tx({ id: "Fx.Heart", atlas: 0, x: 719, y: 1981, width: 20, height: 20 }),
      ShadowMessy: tx({ id: "Fx.ShadowMessy", atlas: 0, x: 1962, y: 0, width: 86, height: 20 }),
      Star: tx({ id: "Fx.Star", atlas: 0, x: 1968, y: 722, width: 64, height: 16 }),
    },
    Overlay: {
