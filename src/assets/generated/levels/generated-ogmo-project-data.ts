...
export namespace OgmoEntities {
  ...
  export type Item = OgmoFactory.EntityBase<{ itemId: "Potato" | "Peeler" | "Grater" | "Garlic" | "Hammer" | "Skillet" | "Cigarette" | "Lighter" | "Egg" | "MixingBowl" | "Scooper" | "Flour" | "HalfCup" | "Onion" | "Carrot" | "Salt" | "Pepper" | "OliveOil" | "SmokeAlarm" | "Whisky" | "WhiskyGlass"; name: string }>;
}
